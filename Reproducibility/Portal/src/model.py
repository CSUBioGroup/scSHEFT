...
class Model(object):
    def __init__(self, batch_size=500, training_steps=2000, seed=1234, npcs=30, n_latent=20, 
                 lambdacos=20.0, lambdaAE=10.0, lambdaLA=10.0, lambdaGAN=1.0, margin=5.,
    ...
    def preprocess(self, 
        ...
        if hvg_num > 1000: # <1000 keep raw
            print("Finding highly variable genes...")   # 两组数据分别找hvg
            ...
            hvg_total = hvg_A.intersection(hvg_B).tolist()
        ...
        if norm_pca:
            self.emb_A = normalize(self.emb_A)
            self.emb_B = normalize(self.emb_B)
    ...
    def train(self):
        ...
        for step in range(self.training_steps):
            ...
            # discriminator loss:  minimize domain classification loss at the x level
