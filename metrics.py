...
from sklearn.metrics import roc_curve, roc_auc_score, accuracy_score, average_precision_score, f1_score, precision_score, recall_score
...
def closed_set_recall_score(preds, labels):
...
def closed_set_precision_score(preds, labels):
...
def closed_set_f1_score(preds, labels):
...
def osr_evaluator(kn_data_closed_pr, kn_data_closed_gt, kn_data_open_pr, unk_data_open_pr=None):
    ...
    kn_data_f1_score = closed_set_f1_score(kn_data_closed_pr, kn_data_closed_gt)
    kn_data_pre = closed_set_precision_score(kn_data_closed_pr, kn_data_closed_gt)
    kn_data_rec = closed_set_recall_score(kn_data_closed_pr, kn_data_closed_gt)
    ...
    print('Accuracy={:.4f}, F1_score={:.4f}, Precision={:.4f}, Recall={:.4f}, Open_AUC={:.4f}, Open_AUPR={:.4f}, OSCR={:.4f}'.format(kn_data_acc, kn_data_f1_score, kn_data_pre, kn_data_rec, auroc, aupr, oscr))
